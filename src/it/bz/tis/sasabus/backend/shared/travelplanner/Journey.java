...
{
   public Journey(Void void1)
   {
   }

   PassList             PassList;
   JourneyAttributeList JourneyAttributeList;
   ...
   {
      for (JourneyAttribute attr : this.JourneyAttributeList.JourneyAttribute)
      {
         if (attr.getAttribute().getType().equals("NUMBER"))
         {
            return attr.getAttribute().getAttributeVariants()[0].getText();
         }
      }
      return "--";
   }
